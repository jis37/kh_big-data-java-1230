package chapter11_예외처리예제7;
// 사용자 정의 예외 클래스 만들기 : 자바에서 제공해 주는 예외 글래스가 사용 목적에 맞는 것이 없을 때 직접 예외 클래스를 만들 수 있다.
...
// 예외 처리 클래스 만들기 : Exception으로 부터 상속 받음
