package chapter6_중첩클래스;
// 중첩클래스 : 하나의 클래스 내부에 선언된 또 다른 클래스를 의미
// 일반적 경우 - 여러 클래스와 관계를 맺는 경우 독립적으로 클래스를 선언 함.
// 특별한 경우 - 특정 클래스와 관계를 맺는 클래스를 내부에 선언 하기도 함.
// 장점
//  - 내부클래스에서 외부 클래스 멤버의 손쉬운 접근 가능
...
public class NestedMain {
    public static void main(String[] args){
        ...
        A a = new A(); // 먼저 외부 클래스를 생성한 후 내부 클래스 생성해야 함
        A.B b = a.new B();
        b.testMethod();
    }
}
