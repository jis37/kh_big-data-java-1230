...
// Vector는 ArrayList 내부적으로 동일한 구조입니다. 메소드의 사용 방법도 완전히 동일 합니다. 멀티스레드에서 안전합니다.
public class VectorEx1 {
    public static void main(String[] args) {
        List<NameCard> list = new Vector<>();
        list.add(new NameCard("우영우","010-1234-5678","yyy@gmail.com","변호사","서울시 강남구 역삼동"));
        list.add(new NameCard("동그라미", "010-5678-1234","ddd@gmail.com","무직", "경기도 인천광역시 강화군"));
        list.add(new NameCard("이준호", "010-3456-2345", "lee@gmail.com","사무직","서울시 서초구"));
