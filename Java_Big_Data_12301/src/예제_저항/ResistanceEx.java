...
// 곱 : 1, 10, 100, 1,000, 10,000, 100,000, 1,000,000, 10,000,000, 1,000,000,000
...
public class ResistanceEx {
    public static void main(String[] args) {
        // 컬러 값에 대한 문자열 배열 생성, 문자열을 비교해서 인덱스를 찾기 위함
        ...
        // Math.pow(2, 3) -> 2 * 2 * 2 // 제곱 함수를 사용해서 풀기
        // 정수 값 범위를 벗어 날 수 있으므로 long으로 형 변환 함
        System.out.println((long)(fstIdx * 10 + secIdx) * (long)Math.pow(10, trdIdx)); // long을 사용해서 형 변환
