...
// Television 만들기
public class TV {
    private boolean isON; // 전원 버튼, 접근 제한자는 private 설정(같은 클래스 내에서만 접근 가능)
    ...
    TV(){
        ...
        channel = 10;
        volume = 10;
        System.out.printf("기본생성자 호출, 전원 : %b, 채널 : %d, 볼륜 : %d", isON, channel, volume);
    }
    ...
    // 외부에서 전원 ON/OFF 할 수 있는 기능을 제공(리모콘등)
