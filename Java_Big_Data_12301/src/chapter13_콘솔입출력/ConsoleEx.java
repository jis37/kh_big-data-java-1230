...
// System.err : 표준 오류 스트림 (System.out과 거의 동일하며 버퍼 사용하는 방법만 다름, 더 좋은 코드(Scanner)가 있어서 사용 안함)
...
//        }
        ...
        os.write(10); // 개입(?) 문자에 대하 종료 ex: enter와 같은 코드를 넣어줌
    }
}
