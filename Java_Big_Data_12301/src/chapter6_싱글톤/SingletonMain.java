...
//        // Singleton singleton = new Singleton(); // private 상태로 사용 할 수 없음
//        Singleton singleton1 = Singleton.getSingleton(); // 싱글톤 객체를 만들때 이미 만들어진 객체의 주소로 만들 수 있음
//        Singleton singleton2 = Singleton.getSingleton();
//        if(singleton1 == singleton2) { // ==는 쓰지 않지만 주소가 같은지 확인 때 사용
